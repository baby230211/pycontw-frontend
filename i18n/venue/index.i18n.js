    ...
    'zh-hant': {
        ...
        parkingInfo: {
            ...
            motor: {
                ...
                description:
                    '機車禁止進入中研院院區。' +
                    '於其大門右側及對面研究院路2段61巷1弄、胡適公園旁均設有機車停車場，供員工和來賓停放不予收費（不負保管責任）。',
            },
            moreInfo: '※停車相關資訊詳細說明請見中研院公告',
        },
        publicTransport: {
            taxi: {
                title: '計程車',
            ...
            uBike: {
                description1:
                    '中研院週邊亦有不少 YouBike 的租借站。更多 YouBike 附近路線的資訊，可以見 YouBike 官方網站 以及 OpenCycleMap，建議還車前留意APP上站點可停駐數量。',
                description2:
                    '由南港車站或南港展覽館站出發騎乘時間約 10-15 分鐘。',
            },
        },
        driveInfo: {
            title: '開車路線',
            ...
            description2:
                '參考路線 桃園國際機場→國道2號(機場支線)→鶯歌系統交流道→國道3號（北二高）→南港系統交流道出口→南深路→舊庄路一段→研究院路二段→中研院大門',
        },
        publicTransportInfo: {
            title: '乘車方式',
