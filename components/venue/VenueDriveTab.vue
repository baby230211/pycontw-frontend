<template>
    <div class="flex flex-col rounded-xl bg-primary-900 px-6 py-10">
        <div class="flex flex-col md:flex-row md:items-center">
            ...
            >
                <img :src="icon.car" />
                <span class="whitespace-nowrap">開車</span>
            </div>
            ...
            <div class="hidden justify-center px-2 md:flex">
                <img :src="icon.venueDestinationMd" />
            </div>

            <div class="flex flex-col items-center justify-center">
                <img class="h-[60px] w-[60px]" :src="icon.parking" />
                <span>停車</span>
            </div>
        </div>
        ...
        <div class="md:flex md:gap-10">
            ...
            <div class="md:flex-1">
                ...
                <p>
                    {{ $t('parkingInfo.motor.description') }}
                </p>
                <p>
                    {{ $t('parkingInfo.moreInfo') }}
                </p>
            </div>
        </div>
    </div>
